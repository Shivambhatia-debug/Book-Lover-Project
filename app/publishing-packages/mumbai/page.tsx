...
const mumbaiPackages = [
  {
    ...
    features: [
      ...
      { text: "Special Shelf Display", included: false },
      { text: "Book Launch", included: false },
      { text: "Premium Corner Display", included: false },
  ...
  },
  {
    ...
    features: [
      { text: "Book Featuring", included: true },
      { text: "Premium Display (Corner Slot)", included: true },
      { text: "Book Signing", included: true },
  ...
  },
  {
    ...
    features: [
      { text: "Book Featuring", included: true },
      { text: "Special Shelf Display", included: true },
      { text: "Premium Display (Corner Slot)", included: true },
      { text: "Book Signing", included: true },
      { text: "Bookmarks", included: true },
      { text: "Book Launch", included: false },
      ...
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
            Mumbai Book Fair Publishing Packages
          </h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Special packages designed for the Mumbai Book Fare Festival. Get exclusive benefits and booth opportunities at the largest literary event in Mumbai.
          </p>
          <Badge className="mt-4 bg-amber-500 text-white px-4 py-2">
            Mumbai Book Fair Special
          </Badge>
        </div>

                 {/* Packages Grid */}
         <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
           {mumbaiPackages.slice(0, 3).map((pkg, index) => (
             <Card
               key={index}
         ...
         <div className="flex justify-center mb-12">
           <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl">
             {mumbaiPackages.slice(3, 5).map((pkg, index) => (
               <Card
                 key={index + 3}
                 className={`relative overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 ${
                   pkg.featured ? "ring-2 ring-amber-500" : ""
               ...
               >
                 ...
                 {/* Special Mumbai Benefits */}
         <Card className="bg-gradient-to-r from-amber-500 to-orange-500 text-white">
           <CardHeader>
             <CardTitle className="text-2xl">Mumbai Book Fair Exclusive Benefits</CardTitle>
           </CardHeader>
           <CardContent>
             <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
               <div className="text-center">
                 ...
                 <p className="text-sm opacity-90">Exclusive booth space at Mumbai Book Fare Festival</p>
               </div>
               <div className="text-center">
                 <Users className="h-12 w-12 mx-auto mb-3" />
                 <h3 className="font-semibold mb-2">Author Meet & Greet</h3>
                 <p className="text-sm opacity-90">Direct interaction with 5000+ book lovers</p>
               </div>
               <div className="text-center">
         ...
         <Card className="bg-gradient-to-r from-blue-500 to-purple-500 text-white mt-8">
           ...
           <CardContent>
             <div className="text-center">
               ...
               <p className="text-3xl font-bold mb-4">₹3,499</p>
