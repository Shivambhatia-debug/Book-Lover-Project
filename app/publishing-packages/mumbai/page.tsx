...
const mumbaiPackages = [
  {
    ...
    featured: false,
    color: "blue",
    subtitle: "Essential package for Mumbai book fair participation",
    description: "Essential package for Mumbai book fair participation.",
    features: [
      "Book Featuring at Mumbai Book Fair",
    ...
    perfectFor: "Authors looking to build local visibility and connect with Mumbai's literary community.",
    timeline: "2-3 weeks",
  ...
  },
  {
    ...
    perfectFor: "Authors aiming for serious local branding and lasting impressions in Mumbai's literary market.",
    timeline: "3-4 weeks",
  ...
  },
  {
    ...
    perfectFor: "Authors seeking maximum exposure and premium positioning at Mumbai Book Fair.",
    timeline: "5-6 weeks",
...
export default function MumbaiPackagePage() {
  ...
  const handleBuyNow = (pkg: any) => {
    const paymentPackage = {
      ...
      description: `Mumbai Book Fair - ${pkg.subtitle}`,
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-amber-50">
      ...
      <section className="relative py-16 bg-gradient-to-r from-amber-900 via-orange-900 to-amber-800 text-white overflow-hidden">
        <div className="absolute inset-0 opacity-20">
          <Image
            src="/images/mumbaibook.jpg"
            alt="Mumbai Book Fair 2025"
            fill
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="mb-6">
            <Badge className="bg-white/20 text-white border-white/30 px-4 py-2 text-lg mb-4">
              📚 Mumbai Book Fair 2025
            </Badge>
          </div>
          <h1 className="text-4xl md:text-6xl font-bold mb-6">
            Showcase Your Book at
            <span className="block text-yellow-300">Mumbai Book Fare Festival</span>
            India
          </h1>
          <p className="text-xl md:text-2xl text-amber-100 max-w-4xl mx-auto mb-8 leading-relaxed">
            Be part of Mumbai's largest literary event and connect with 5000+ book lovers!
          </p>
          <p className="text-lg text-amber-200 max-w-3xl mx-auto mb-8">
            Your book deserves a prominent platform. Let readers, publishers, and literary enthusiasts from Mumbai and beyond discover your work — proudly represented by Booklover Publishing House.
          </p>
          ...
          <div className="flex flex-wrap justify-center gap-6 text-white">
            ...
            <div className="flex items-center">
              ...
              <span className="font-semibold">5000+ Expected Attendees</span>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Choose Your Mumbai Book Fair Package
            </h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
            {mumbaiPackages.slice(0, 3).map((pkg) => {
          ...
          <div className="flex justify-center">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl">
              {mumbaiPackages.slice(3, 5).map((pkg) => {
                const colors = getColorClasses(pkg.color)
                const IconComponent = pkg.icon
      ...
      {/* Why Mumbai Book Fair Section */}
      <section className="py-16 bg-gradient-to-r from-gray-50 to-amber-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Why Mumbai Book Fair?
            </h2>
            <p className="text-xl text-gray-600">
              FROM THE HEART OF MUMBAI TO THE SHELVES OF INDIA<br />
            ...
            {[
              {
                ...
                description: "Connect with Mumbai's largest literary community"
              },
              {
                icon: Award,
                title: "Local Recognition",
                description: "Showcase at Mumbai's premier book event"
              },
              {
                icon: Camera,
      ...
      <section className="py-16 bg-gradient-to-r from-amber-900 to-orange-900 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 text-amber-100">
            Join us at Mumbai Book Fare Festival and let your story reach thousands of readers!
          </p>
