...
const punePackages = [
  {
    ...
    featured: false,
    color: "blue",
    subtitle: "Essential package for Pune book fair participation",
    description: "Essential package for Pune book fair participation.",
    features: [
      "Book Featuring at Pune Book Fair",
    ...
    perfectFor: "Authors looking to build local visibility and connect with Pune's literary community.",
    timeline: "2-3 weeks",
  ...
  },
  {
    ...
    perfectFor: "Authors aiming for serious local branding and lasting impressions in Pune's literary market.",
    timeline: "3-4 weeks",
  ...
  },
  {
    ...
    perfectFor: "Authors seeking maximum exposure and premium positioning at Pune Book Fair.",
    timeline: "5-6 weeks",
...
export default function PunePackagePage() {
  ...
  const handleBuyNow = (pkg: any) => {
    const paymentPackage = {
      ...
      description: `Pune Book Fair - ${pkg.subtitle}`,
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-amber-50">
      ...
      <section className="relative py-16 bg-gradient-to-r from-amber-900 via-orange-900 to-amber-800 text-white overflow-hidden">
        <div className="absolute inset-0 opacity-20">
          <Image
            src="/images/punebook.jpg"
            alt="Pune Book Fair 2025"
            fill
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="text-4xl md:text-6xl font-bold mb-6">
            ...
            <span className="block text-yellow-300">Pune Book Fare Festival</span>
            India
          </h1>
          <p className="text-xl md:text-2xl text-amber-100 max-w-4xl mx-auto mb-8 leading-relaxed">
            Be part of Pune's largest literary event and connect with 8000+ book lovers!
          </p>
          <p className="text-lg text-amber-200 max-w-3xl mx-auto mb-8">
            Your book deserves a prominent platform. Let readers, publishers, and literary enthusiasts from Pune and beyond discover your work — proudly represented by Booklover Publishing House.
          </p>
          ...
          <div className="flex flex-wrap justify-center gap-6 text-white">
            ...
            <div className="flex items-center">
              ...
              <span className="font-semibold">8000+ Expected Attendees</span>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Choose Your Pune Book Fair Package
            </h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
            {punePackages.slice(0, 3).map((pkg) => {
          ...
          <div className="flex justify-center">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl">
              {punePackages.slice(3, 5).map((pkg) => {
                const colors = getColorClasses(pkg.color)
                const IconComponent = pkg.icon
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              FROM THE HEART OF PUNE TO THE SHELVES OF INDIA<br />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              {
                icon: Users,
                title: "8000+ Attendees",
                description: "Connect with Pune's largest literary community"
              },
              {
                icon: Award,
                title: "Local Recognition",
                description: "Showcase at Pune's premier book event"
              },
              {
                icon: Camera,
      ...
      <section className="py-16 bg-gradient-to-r from-amber-900 to-orange-900 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 text-amber-100">
            Join us at Pune Book Fare Festival and let your story reach thousands of readers!
          </p>
